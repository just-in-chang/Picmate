...
ActiveRecord::Schema.define(version: 2021_09_21_210327) do
  ...
  create_table "user_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "relating_user_id"
    t.bigint "related_user_id"
    t.index ["related_user_id"], name: "index_user_relationships_on_related_user_id"
    t.index ["relating_user_id"], name: "index_user_relationships_on_relating_user_id"
  end
  ...
  add_foreign_key "user_relationships", "users", column: "relating_user_id"
end
